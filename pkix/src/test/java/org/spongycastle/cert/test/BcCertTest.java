    ...
    extends TestCase
{
        ...
        throws Exception
    {
        ...
        builder.addRDN(PKCSObjectIdentifiers.pkcs_9_at_emailAddress, "feedback-crypto.spongycastle.org");
...
//
    ...
    /**
     ...
     public void checkCreation3()
     {
         ...
         if (!s.equals("1.2.840.113549.1.9.1=feedback-crypto.spongycastle.org,st=Victoria,l=Melbourne,o=The Legion of the Bouncy Castle,c=AU"))
         {
